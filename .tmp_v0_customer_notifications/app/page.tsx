...
import { FileText, Bookmark, Bell, ArrowRight } from "lucide-react"
          ...
          <Card className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Customer activity center. See what needs attention, filter by type, and quickly return to messages, requests, and provider updates.
                </p>
                <Button asChild>
