...
Object.assign(TRANSLATIONS.ar, {
  ...
  'Failed to refresh provider data.': 'فشل تحديث بيانات المزود.',
  'Failed to load the provider page.': 'فشل تحميل صفحة المزود.',
  'This action is available for customer accounts only.': 'هذا الإجراء متاح لحسابات العملاء فقط.',
  'Provider removed from favorites.': 'تمت إزالة المزود من المفضلة.',
  'Failed to update favorites.': 'فشل تحديث المفضلة.',
  'Review submitted.': 'تم إرسال التقييم.',
  'Failed to submit the review.': 'فشل إرسال التقييم.',
  'Request description is required.': 'وصف الطلب مطلوب.',
  'Service request sent.': 'تم إرسال طلب الخدمة.',
  'Failed to submit the request.': 'فشل إرسال الطلب.',
  'Failed to refresh comments.': 'فشل تحديث التعليقات.',
  'Failed to update like state.': 'فشل تحديث حالة الإعجاب.',
  'Write a comment first.': 'اكتب تعليقًا أولاً.',
  'Sending...': 'جارٍ الإرسال...',
  'Comment added.': 'تمت إضافة التعليق.',
  'Failed to add the comment.': 'فشل إضافة التعليق.',
  'Write a reply first.': 'اكتب ردًا أولاً.',
  'Reply sent successfully.': 'تم إرسال الرد بنجاح.',
  'Failed to send the story reply.': 'فشل إرسال رد القصة.',
  'Sign in to reply': 'سجل الدخول للرد',
  'Customer account required': 'حساب عميل مطلوب',
  'Reply in chat': 'رد في المحادثة',
  'Sign in with a customer account to reply to this story.': 'سجل الدخول بحساب عميل للرد على هذه القصة.',
  'Story replies are available to customer accounts.': 'الرد على القصص متاح لحسابات العملاء.',
  'Reply to this story...': 'الرد على هذه القصة...',
  'Browse provider profile': 'تصفح ملف المزود',
  'Media archive': 'أرشيف الوسائط',
  'Publish this item': 'نشر هذا العنصر',
  'Publish story': 'نشر قصة',
  'Publish item': 'نشر عنصر',
  'Story audience': 'جمهور القصة',
  'Queue filters': 'مرشحات الطابور',
  'Decision filters': 'مرشحات القرارات',
  'Provider queue filters': 'مرشحات طابور المزودين',
  'Provider moderation queue': 'طابور مراجعة المزودين',
  'Current plan': 'الخطة الحالية',
  'Related service': 'الخدمة المرتبطة',
  'No linked service': 'لا توجد خدمة مرتبطة',
  'Publish this as a story (expires automatically after 24 hours)':
    'انشر هذا كقصة (تنتهي تلقائيًا بعد 24 ساعة)',
  'Public - everyone can see it': 'عام - يمكن للجميع رؤيتها',
  'Public â€” everyone can see it': 'عام - يمكن للجميع رؤيتها',
  'Favorites only - only customers who favorited you':
    'المفضلة فقط - العملاء الذين أضافوك للمفضلة فقط',
  'Favorites only â€” only customers who favorited you':
    'المفضلة فقط - العملاء الذين أضافوك للمفضلة فقط',
  'Main file': 'الملف الرئيسي',
  'Choose image or video from computer': 'اختر صورة أو فيديو من الجهاز',
  'Video thumbnail': 'صورة مصغرة للفيديو',
  'Optional thumbnail image': 'صورة مصغرة اختيارية',
  'Sort order': 'ترتيب العرض',
  'Mark as featured work': 'تمييز كعمل بارز',
  'Show promo badge': 'إظهار شارة ترويجية',
  'Promo badge text': 'نص الشارة الترويجية',
  'New / Popular / Fast delivery': 'جديد / شائع / تسليم سريع',
  'Saving...': 'جارٍ الحفظ...',
  Reset: 'إعادة تعيين',
  'Total items': 'إجمالي العناصر',
  'No items match this filter.': 'لا توجد عناصر تطابق هذا المرشح.',
  Story: 'قصة',
...
Object.assign(TRANSLATIONS.fr, {
  ...
  'Failed to refresh provider data.': 'Echec de mise a jour des donnees prestataire.',
  'Failed to load the provider page.': 'Echec de chargement de la page prestataire.',
  'This action is available for customer accounts only.':
    'Cette action est disponible uniquement pour les comptes client.',
  'Provider removed from favorites.': 'Prestataire retire des favoris.',
  'Failed to update favorites.': 'Echec de mise a jour des favoris.',
  'Review submitted.': 'Avis envoye.',
  'Failed to submit the review.': 'Echec de l envoi de l avis.',
  'Request description is required.': 'La description de la demande est obligatoire.',
  'Service request sent.': 'Demande de service envoyee.',
  'Failed to submit the request.': 'Echec de l envoi de la demande.',
  'Failed to refresh comments.': 'Echec de rafraichissement des commentaires.',
  'Failed to update like state.': 'Echec de mise a jour du statut j aime.',
  'Write a comment first.': 'Ecrivez un commentaire d abord.',
  'Sending...': 'Envoi...',
  'Comment added.': 'Commentaire ajoute.',
  'Failed to add the comment.': 'Echec de l ajout du commentaire.',
  'Write a reply first.': 'Ecrivez une reponse d abord.',
  'Reply sent successfully.': 'Reponse envoyee avec succes.',
  'Failed to send the story reply.': 'Echec de l envoi de la reponse story.',
  'Sign in to reply': 'Connectez-vous pour repondre',
  'Customer account required': 'Compte client requis',
  'Reply in chat': 'Repondre dans le chat',
  'Sign in with a customer account to reply to this story.':
    'Connectez-vous avec un compte client pour repondre a cette story.',
  'Story replies are available to customer accounts.':
    'Les reponses aux stories sont reservees aux comptes client.',
  'Reply to this story...': 'Repondre a cette story...',
  'Browse provider profile': 'Voir le profil du prestataire',
  'Media archive': 'Archive media',
  'Publish this item': 'Publier cet element',
  'Publish story': 'Publier la story',
  'Publish item': 'Publier l element',
  'Story audience': 'Audience de la story',
  'Queue filters': 'Filtres de file',
  'Decision filters': 'Filtres de decision',
  'Provider queue filters': 'Filtres de file prestataires',
  'Provider moderation queue': 'File de moderation des prestataires',
  'Current plan': 'Plan actuel',
  'Related service': 'Service associe',
  'No linked service': 'Aucun service lie',
  'Publish this as a story (expires automatically after 24 hours)':
    'Publier ceci comme story (expire automatiquement apres 24 heures)',
  'Public - everyone can see it': 'Public - tout le monde peut la voir',
  'Public â€” everyone can see it': 'Public - tout le monde peut la voir',
  'Favorites only - only customers who favorited you':
    'Favoris seulement - uniquement les clients qui vous ont ajoute en favoris',
  'Favorites only â€” only customers who favorited you':
    'Favoris seulement - uniquement les clients qui vous ont ajoute en favoris',
  'Main file': 'Fichier principal',
  'Choose image or video from computer': 'Choisissez une image ou video depuis l ordinateur',
  'Video thumbnail': 'Miniature video',
  'Optional thumbnail image': 'Miniature optionnelle',
  'Sort order': 'Ordre de tri',
  'Mark as featured work': 'Marquer comme realisation mise en avant',
  'Show promo badge': 'Afficher le badge promo',
  'Promo badge text': 'Texte du badge promo',
  'New / Popular / Fast delivery': 'Nouveau / Populaire / Livraison rapide',
  'Saving...': 'Enregistrement...',
  Reset: 'Reinitialiser',
  'Total items': 'Total des elements',
  'No items match this filter.': 'Aucun element ne correspond a ce filtre.',
  Story: 'Story',
  ...
  'Choose an image or video first.': 'Choisissez d abord une image ou video.',
  'Failed to load portfolio data.': 'Echec du chargement des donnees portfolio.',
  'Item updated successfully.': 'Element mis a jour avec succes.',
  'Story published successfully.': 'Story publiee avec succes.',
  'Portfolio item published successfully.': 'Element de portfolio publie avec succes.',
  'Action failed.': 'Echec de l action.',
  'Delete this item?': 'Supprimer cet element ?',
  'Item deleted successfully.': 'Element supprime avec succes.',
  'Failed to delete the item.': 'Echec de suppression de l element.',
  'Failed to load comments.': 'Echec du chargement des commentaires.',
  'Comment deleted successfully.': 'Commentaire supprime avec succes.',
  'Failed to delete the comment.': 'Echec de suppression du commentaire.',
  'Title is required.': 'Le titre est obligatoire.',
  'Edit media / story': 'Modifier media / story',
  'Publish portfolio item or story': 'Publier un element portfolio ou une story',
  'Stories now support two audiences: public and favorite-followers only.':
    'Les stories supportent deux audiences: public et abonnes favoris seulement.',
  Algeria: 'Algerie',
});

Object.assign(TRANSLATIONS.ar, {
  'Verified provider': 'مزود موثّق',
  'active story': 'قصة نشطة',
  'active stories': 'قصص نشطة',
  Reach: 'النطاق',
  'Profile sections': 'أقسام الملف',
  'Scan offers first, then proof of work, then reviews.':
    'ابدأ بالعروض ثم نماذج الأعمال ثم التقييمات.',
  works: 'أعمال',
  reply: 'رد',
  'Create a service request': 'إنشاء طلب خدمة',
  'Share the brief, timing, and budget so the provider can reply faster.':
    'شارك المتطلبات والتوقيت والميزانية ليتمكن المزود من الرد بسرعة.',
  Close: 'إغلاق',
  'No specific service selected': 'لم يتم اختيار خدمة محددة',
  'Short request subject': 'عنوان مختصر للطلب',
  'Describe the work clearly.': 'صف العمل بوضوح.',
  'Budget min': 'الميزانية الدنيا',
  'Budget max': 'الميزانية العليا',
  Currency: 'العملة',
  'Optional opening message': 'رسالة افتتاحية اختيارية',
  'Strong requests are easier to answer. Include the location, what should be delivered, and any deadline or budget constraints that matter.':
    'الطلبات الواضحة أسهل في الرد. أضف الموقع والمخرجات المطلوبة وأي قيود زمنية أو ميزانية.',
  'Sending request...': 'جارٍ إرسال الطلب...',
  'Send request': 'إرسال الطلب',
  'Featured work': 'عمل مميز',
  'Standalone portfolio item': 'عنصر مستقل في المعرض',
  ...
  Comment: 'تعليق',
  'Portfolio and proof of work': 'المعرض وإثبات العمل',
  'This is the live proof layer: images, videos, likes, comments, and recent customer reactions.':
    'هذه طبقة الإثبات الحي: صور وفيديوهات وإعجابات وتعليقات وتفاعلات العملاء الأخيرة.',
  images: 'صور',
  videos: 'فيديوهات',
  ...
  'These offers can be requested directly from the profile and are structured for quick customer comparison.':
    'يمكن طلب هذه العروض مباشرة من الملف وهي منظمة للمقارنة السريعة.',
  'No published services are visible on this profile yet.':
    'لا توجد خدمات منشورة ظاهرة في هذا الملف حتى الآن.',
  'Spotlight service': 'الخدمة المميزة',
  'Starting point': 'نقطة البداية',
  'Price on request': 'السعر عند الطلب',
  'No category': 'بدون تصنيف',
  'Reply in': 'الرد خلال',
  'Request this service': 'اطلب هذه الخدمة',
  'Similar providers': 'مزودون مشابهون',
  'Customer reviews': 'تقييمات العملاء',
  'Ratings are public quality signals and feed the discovery ranking.':
    'التقييمات إشارات جودة عامة وتؤثر في ترتيب الاكتشاف.',
  'Update your review': 'حدّث تقييمك',
  'Leave a review': 'اكتب تقييمًا',
  'Customer reviews require a customer account.':
    'إضافة التقييم تتطلب حساب عميل.',
  star: 'نجمة',
  stars: 'نجوم',
  'Describe the quality of the interaction and the delivered work.':
    'صف جودة التعامل والعمل الذي تم تسليمه.',
  'Update review': 'تحديث التقييم',
  'Submit review': 'إرسال التقييم',
  'No customer reviews have been published yet.':
    'لم يتم نشر تقييمات عملاء بعد.',
  'No written comment was provided.': 'لم يتم إدراج تعليق مكتوب.',
  'Story updates': 'تحديثات القصص',
  'View recent story posts in a dedicated viewer, then reply directly into messaging.':
    'اعرض أحدث القصص في عارض مخصص ثم رد مباشرة عبر الرسائل.',
  public: 'عام',
  'favorites only': 'المفضلة فقط',
  'Provider story': 'قصة المزود',
  Expires: 'ينتهي',
  'Active now': 'نشط الآن',
  'Reach, trust, and booking context': 'النطاق والثقة وسياق الحجز',
  'Keep only the support context needed after the service and proof sections are already clear.':
    'احتفظ فقط بسياق الدعم المطلوب بعد وضوح الخدمات وإثبات العمل.',
  'Primary category': 'التصنيف الأساسي',
  'Not specified': 'غير محدد',
  'Base location': 'الموقع الأساسي',
  'Service coverage': 'نطاق الخدمة',
  'Travel estimate': 'تقدير التنقل',
  Plan: 'الخطة',
  'Moderation status': 'حالة المراجعة',
  Hidden: 'مخفي',
  'Location handoff': 'تسليم الموقع',
  'Use map handoff only when visit planning or on-site scope matters. It is supporting context, not the main decision surface.':
    'استخدم تسليم الخريطة فقط عند الحاجة لزيارة ميدانية. هذا سياق داعم وليس القرار الأساسي.',
  'Map destination': 'وجهة الخريطة',
  Coverage: 'التغطية',
  'Travel fit': 'ملاءمة التنقل',
  'Maps handoff': 'تسليم الخرائط',
  'external navigation only when needed': 'تنقل خارجي عند الحاجة فقط',
  'Open in Google Maps': 'افتح في خرائط Google',
  'Open provider profile': 'افتح ملف المزود',
  'Story viewer': 'عارض القصة',
  'Story stats': 'إحصاءات القصة',
  story: 'قصة',
  stories: 'قصص',
  comments: 'تعليقات',
  Format: 'النوع',
  'Video story': 'قصة فيديو',
  'Image story': 'قصة صورة',
  'Reply to this story': 'الرد على هذه القصة',
  Previous: 'السابق',
  Next: 'التالي',
  'Local-first Algerian discovery': 'اكتشاف محلي موجّه للجزائر',
  'Search providers with local precision': 'ابحث عن المزودين بدقة محلية',
  'Discovery is now structured around Algeria-specific geography. Search by service need, city, region, wilaya, and category without losing deep-linking or ranking quality.':
    'تم تنظيم الاكتشاف وفق الجغرافيا الجزائرية. ابحث حسب الخدمة والمدينة والجهة والولاية والتصنيف دون فقدان الروابط العميقة أو جودة الترتيب.',
  'Search by service, skill, or category': 'ابحث حسب الخدمة أو المهارة أو التصنيف',
  'City / Commune / Locality': 'المدينة / البلدية / المنطقة',
  'All marketplace regions': 'جميع جهات السوق',
  'All wilayas': 'جميع الولايات',
  'Active search': 'البحث النشط',
  'The current URL already preserves filters and ranking. Adjust, search, and share the same state without losing context.':
    'عنوان الصفحة الحالي يحفظ المرشحات والترتيب. عدّل وابحث وشارك نفس الحالة دون فقدان السياق.',
  Query: 'الاستعلام',
  'Any service need': 'أي حاجة خدمية',
  'Local focus': 'التركيز المحلي',
  'All Algeria': 'كل الجزائر',
  Ranking: 'الترتيب',
  'Filters and ranking': 'المرشحات والترتيب',
  'Narrow the visible provider set first, then switch ranking once the shortlist is close to the right scope.':
    'ابدأ بتضييق قائمة المزودين الظاهرة ثم غيّر الترتيب بعد اقتراب النطاق المناسب.',
  provider: 'مزود',
  providers: 'مزودون',
  Subcategories: 'التصنيفات الفرعية',
  'All in this main category': 'الكل داخل هذا التصنيف الرئيسي',
  'Sort by': 'الفرز حسب',
  'Featured first': 'المميز أولًا',
  'Verified first': 'الموثق أولًا',
  'Highest rated': 'الأعلى تقييمًا',
  'Discovery search failed.': 'فشل بحث الاكتشاف.',
  'Retry search': 'إعادة المحاولة',
  'No providers matched the current filters.': 'لا يوجد مزودون يطابقون المرشحات الحالية.',
  'Try removing the local filters or search with broader service terms.':
    'جرّب إزالة المرشحات المحلية أو البحث بمصطلحات أوسع.',
  'Clear filters': 'مسح المرشحات',
  Rating: 'التقييم',
  category: 'التصنيف',
  'first reply': 'أول رد',
  'Declared on profile': 'مصرح به في الملف',
  reach: 'النطاق',
  years: 'سنوات',
  experience: 'خبرة',
  'Open provider profile for services': 'افتح ملف المزود لعرض الخدمات',
  'View profile': 'عرض الملف',
  'Request service': 'طلب خدمة',
  'Open map': 'افتح الخريطة',
  'Failed to load favorite providers.': 'فشل تحميل المزودين المفضلين.',
  'Failed to remove provider from favorites.': 'فشل إزالة المزود من المفضلة.',
  'Saved providers': 'المزودون المحفوظون',
  'Your active shortlist for future comparison and follow-up.':
    'قائمتك المختصرة النشطة للمقارنة والمتابعة.',
  'Saved providers that already carry marketplace trust signals.':
    'مزودون محفوظون لديهم إشارات ثقة في السوق.',
  'Average shortlist rating': 'متوسط تقييم القائمة المختصرة',
  'A quick quality signal across the providers you saved.':
    'إشارة جودة سريعة عبر المزودين الذين حفظتهم.',
  'Favorites unavailable.': 'المفضلة غير متاحة.',
  'Shortlist workspace': 'مساحة عمل القائمة المختصرة',
  'Keep the providers worth returning to': 'احتفظ بالمزودين الذين يستحقون العودة إليهم',
  'Favorites should reduce decision friction. From here you can reopen the profile, start a conversation, create a request, or clean the shortlist when a provider is no longer relevant.':
    'المفضلة يجب أن تقلل تعقيد القرار. من هنا يمكنك فتح الملف أو بدء محادثة أو إنشاء طلب أو تنظيف القائمة.',
  'Saved now': 'محفوظ الآن',
  'Verified inside shortlist': 'موثق داخل القائمة',
  'Ready to message': 'جاهز للمراسلة',
  'Ready to request': 'جاهز للطلب',
  'This is a working shortlist, not a passive list. Every card can move directly into action.':
    'هذه قائمة عمل وليست قائمة ساكنة. كل بطاقة تقود مباشرة إلى إجراء.',
  'Explore more providers': 'استكشف مزودين أكثر',
  'Best shortlist signal': 'أفضل إشارة في القائمة',
  'Highest current rating in your saved shortlist. Use this as the fastest candidate when you want to reopen the pipeline now.':
    'أعلى تقييم حالي داخل قائمتك المحفوظة. استخدمه كأفضل مرشح سريع لإعادة فتح المسار الآن.',
  'Save providers from Explore to build a usable shortlist.':
    'احفظ مزودين من صفحة الاستكشاف لبناء قائمة مختصرة عملية.',
  'All shortlist': 'كل القائمة',
  'Verified only': 'الموثق فقط',
  'Top rated': 'الأعلى تقييمًا',
  'No providers saved yet.': 'لا يوجد مزودون محفوظون بعد.',
  'Use Explore to save providers you want to compare or contact later.':
    'استخدم الاستكشاف لحفظ المزودين الذين تريد مقارنتهم أو التواصل معهم.',
  'Open Explore': 'افتح الاستكشاف',
  'No providers match this shortlist filter.': 'لا يوجد مزودون يطابقون هذا المرشح.',
  'Try another filter to reopen the rest of your saved providers.':
    'جرّب مرشحًا آخر لعرض بقية المزودين المحفوظين.',
  'Remove favorite': 'إزالة من المفضلة',
  Removing: 'إزالة',
  'Removing...': 'جارٍ الإزالة...',
  'Failed to load your reviews.': 'فشل تحميل تقييماتك.',
  'Review deleted.': 'تم حذف التقييم.',
  'Failed to delete review.': 'فشل حذف التقييم.',
  'Published reviews': 'التقييمات المنشورة',
  'Reviews you have written across provider profiles.':
    'التقييمات التي كتبتها عبر ملفات المزودين.',
  'Average rating given': 'متوسط التقييم الذي منحته',
  'A simple view of how demanding your public feedback has been.':
    'عرض مبسط لمدى صرامة تقييماتك العامة.',
  'With written comments': 'مع تعليقات مكتوبة',
  'Reviews that include context beyond the star rating.':
    'تقييمات تتضمن سياقًا يتجاوز عدد النجوم.',
  'Reviews unavailable.': 'التقييمات غير متاحة.',
  'Review history': 'سجل التقييمات',
  'Manage the feedback you have already published':
    'إدارة التعليقات التي قمت بنشرها مسبقًا',
  'Reviews shape public trust and discovery ranking. From here you can reopen the provider profile or delete feedback that is no longer accurate.':
    'التقييمات تؤثر على الثقة العامة وترتيب الاكتشاف. من هنا يمكنك فتح ملف المزود أو حذف تعليق لم يعد دقيقًا.',
  'Total reviews': 'إجمالي التقييمات',
  'Providers reviewed': 'المزودون الذين تم تقييمهم',
  'Ratings given': 'التقييمات الممنوحة',
  Active: 'نشط',
  'None yet': 'لا شيء بعد',
  'Delete control': 'تحكم الحذف',
  Available: 'متاح',
  'Your published reviews': 'تقييماتك المنشورة',
  'Open the provider profile to add new feedback in context, or remove an outdated review directly from here.':
    'افتح ملف المزود لإضافة تقييم جديد في سياقه أو احذف تقييمًا قديمًا مباشرة من هنا.',
  'Rating distribution': 'توزيع التقييمات',
  'All reviews': 'كل التقييمات',
  'With comments': 'مع تعليقات',
  '4 stars and above': '4 نجوم فأكثر',
  'You have not published any reviews yet.': 'لم تنشر أي تقييمات بعد.',
  'Open a provider profile from Explore when you want to leave public feedback.':
    'افتح ملف مزود من الاستكشاف عندما تريد ترك تقييم عام.',
  'No reviews match this filter.': 'لا توجد تقييمات تطابق هذا المرشح.',
  'Switch filters to inspect the rest of your published feedback.':
    'بدّل المرشحات لمراجعة بقية تقييماتك المنشورة.',
  Provider: 'مزود',
  'Open provider': 'افتح المزود',
  'Deleting...': 'جارٍ الحذف...',
  'No written comment was included with this review.':
    'لم يتم تضمين تعليق مكتوب مع هذا التقييم.',
  Current: 'الحالي',
  CU: 'عم',
  'Lead inbox': 'صندوق العملاء المحتملين',
  'Request brief': 'ملخص الطلب',
  Lifecycle: 'دورة الحياة',
  'Customer context': 'سياق العميل',
  'Quote and status controls': 'عناصر التحكم في التسعير والحالة',
  'Operational priorities': 'الأولويات التشغيلية',
  'Growth levers': 'مفاتيح النمو',
  'Recent services': 'الخدمات الأخيرة',
  'Public — everyone can see it': 'عام — يمكن للجميع رؤيتها',
  'Favorites only — only customers who favorited you':
    'المفضلة فقط — فقط العملاء الذين أضافوك للمفضلة',
});
...
Object.assign(TRANSLATIONS.fr, {
  ...
  Reach: 'Portee',
  'Profile sections': 'Sections du profil',
  'Scan offers first, then proof of work, then reviews.':
    'Parcourez les offres, puis les preuves de travail, puis les avis.',
  works: 'realisations',
  reply: 'reponse',
  'Create a service request': 'Creer une demande de service',
  'Share the brief, timing, and budget so the provider can reply faster.':
    'Partagez le brief, le delai et le budget pour accelerer la reponse.',
  Close: 'Fermer',
  'No specific service selected': 'Aucun service specifique selectionne',
  'Short request subject': 'Objet court de la demande',
  'Describe the work clearly.': 'Decrivez clairement le travail.',
  'Budget min': 'Budget min',
  'Budget max': 'Budget max',
  Currency: 'Devise',
  'Optional opening message': 'Message d ouverture optionnel',
  'Strong requests are easier to answer. Include the location, what should be delivered, and any deadline or budget constraints that matter.':
    'Les demandes claires sont plus faciles a traiter. Ajoutez lieu, livrables et contraintes.',
  'Sending request...': 'Envoi de la demande...',
  'Send request': 'Envoyer la demande',
  'Featured work': 'Realisation mise en avant',
  'Standalone portfolio item': 'Element de portfolio autonome',
  ...
  Comment: 'Commenter',
  'Portfolio and proof of work': 'Portfolio et preuve de travail',
  'This is the live proof layer: images, videos, likes, comments, and recent customer reactions.':
    'Couche de preuve en direct: images, videos, j aime, commentaires et reactions recentes.',
  images: 'images',
  videos: 'videos',
  'total interactions': 'interactions totales',
  'Published services': 'Services publies',
  'These offers can be requested directly from the profile and are structured for quick customer comparison.':
    'Ces offres sont demandables depuis le profil et organisees pour une comparaison rapide.',
  'No published services are visible on this profile yet.':
    'Aucun service publie visible sur ce profil pour le moment.',
  'Spotlight service': 'Service vedette',
  'Starting point': 'Point de depart',
  'Price on request': 'Prix sur demande',
  'No category': 'Aucune categorie',
  'Reply in': 'Reponse en',
  'Request this service': 'Demander ce service',
  'Similar providers': 'Prestataires similaires',
  'Customer reviews': 'Avis clients',
  'Ratings are public quality signals and feed the discovery ranking.':
    'Les notes sont des signaux publics de qualite et influencent le classement.',
  'Update your review': 'Mettre a jour votre avis',
  'Leave a review': 'Laisser un avis',
  'Customer reviews require a customer account.':
    'Les avis clients necessitent un compte client.',
  star: 'etoile',
  stars: 'etoiles',
  'Describe the quality of the interaction and the delivered work.':
    'Decrivez la qualite de l interaction et du travail livre.',
  'Update review': 'Mettre a jour l avis',
  'Submit review': 'Envoyer l avis',
  'No customer reviews have been published yet.':
    'Aucun avis client publie pour le moment.',
  'No written comment was provided.': 'Aucun commentaire ecrit fourni.',
  'Story updates': 'Mises a jour story',
  'View recent story posts in a dedicated viewer, then reply directly into messaging.':
    'Voir les stories recentes dans un viewer dedie puis repondre dans la messagerie.',
  public: 'public',
  'favorites only': 'favoris seulement',
  'Provider story': 'Story prestataire',
  Expires: 'Expire',
  'Active now': 'Actif maintenant',
  'Reach, trust, and booking context': 'Portee, confiance et contexte de reservation',
  'Keep only the support context needed after the service and proof sections are already clear.':
    'Gardez uniquement le contexte utile une fois services et preuves clarifies.',
  'Primary category': 'Categorie principale',
  'Not specified': 'Non specifie',
  'Base location': 'Localisation de base',
  'Service coverage': 'Couverture du service',
  'Travel estimate': 'Estimation de deplacement',
  Plan: 'Plan',
  'Moderation status': 'Statut de moderation',
  Hidden: 'Masque',
  'Location handoff': 'Relais de localisation',
  'Use map handoff only when visit planning or on-site scope matters. It is supporting context, not the main decision surface.':
    'Utilisez la carte seulement si une visite sur site est necessaire.',
  'Map destination': 'Destination carte',
  Coverage: 'Couverture',
  'Travel fit': 'Compatibilite de deplacement',
  'Maps handoff': 'Relais cartographique',
  'external navigation only when needed': 'navigation externe uniquement si necessaire',
  'Open in Google Maps': 'Ouvrir dans Google Maps',
  'Open provider profile': 'Ouvrir le profil prestataire',
  'Story viewer': 'Visionneuse story',
  'Story stats': 'Stats story',
  story: 'story',
  stories: 'stories',
  comments: 'commentaires',
  Format: 'Format',
  'Video story': 'Story video',
  'Image story': 'Story image',
  'Reply to this story': 'Repondre a cette story',
  Previous: 'Precedent',
  Next: 'Suivant',
  'Local-first Algerian discovery': 'Decouverte locale orientee Algerie',
  'Search providers with local precision': 'Rechercher des prestataires avec precision locale',
  'Discovery is now structured around Algeria-specific geography. Search by service need, city, region, wilaya, and category without losing deep-linking or ranking quality.':
    'La decouverte suit la geographie algerienne: service, ville, region, wilaya et categorie.',
  'Search by service, skill, or category': 'Rechercher par service, competence ou categorie',
  'City / Commune / Locality': 'Ville / Commune / Localite',
  'All marketplace regions': 'Toutes les regions du marketplace',
  'All wilayas': 'Toutes les wilayas',
  'Active search': 'Recherche active',
  'The current URL already preserves filters and ranking. Adjust, search, and share the same state without losing context.':
    'L URL conserve deja filtres et tri. Ajustez, recherchez et partagez sans perdre le contexte.',
  Query: 'Requete',
  'Any service need': 'Tout besoin de service',
  'Local focus': 'Focus local',
  'All Algeria': 'Toute l Algerie',
  Ranking: 'Classement',
  'Filters and ranking': 'Filtres et classement',
  'Narrow the visible provider set first, then switch ranking once the shortlist is close to the right scope.':
    'Affinez d abord les prestataires visibles puis ajustez le tri.',
  provider: 'prestataire',
  providers: 'prestataires',
  Subcategories: 'Sous-categories',
  'All in this main category': 'Tout dans cette categorie principale',
  'Sort by': 'Trier par',
  'Featured first': 'Mises en avant d abord',
  'Verified first': 'Verifies d abord',
  'Highest rated': 'Mieux notes',
  'Discovery search failed.': 'Echec de la recherche de decouverte.',
  'Retry search': 'Relancer la recherche',
  'No providers matched the current filters.':
    'Aucun prestataire ne correspond aux filtres actuels.',
  'Try removing the local filters or search with broader service terms.':
    'Essayez de retirer des filtres locaux ou d elargir les termes de recherche.',
  'Clear filters': 'Effacer les filtres',
  Rating: 'Note',
  category: 'categorie',
  'first reply': 'premiere reponse',
  'Declared on profile': 'Declare sur le profil',
  reach: 'portee',
  years: 'ans',
  ...
  'Failed to load favorite providers.': 'Echec du chargement des prestataires favoris.',
  'Failed to remove provider from favorites.':
    'Echec de suppression du prestataire des favoris.',
  'Saved providers': 'Prestataires sauvegardes',
  'Your active shortlist for future comparison and follow-up.':
    'Votre shortlist active pour comparaison et suivi.',
  'Saved providers that already carry marketplace trust signals.':
    'Prestataires sauvegardes avec signaux de confiance.',
  'Average shortlist rating': 'Note moyenne de la shortlist',
  'A quick quality signal across the providers you saved.':
    'Signal qualite rapide sur vos prestataires sauvegardes.',
  'Favorites unavailable.': 'Favoris indisponibles.',
  'Shortlist workspace': 'Espace shortlist',
  'Keep the providers worth returning to':
    'Gardez les prestataires vers lesquels revenir',
  'Favorites should reduce decision friction. From here you can reopen the profile, start a conversation, create a request, or clean the shortlist when a provider is no longer relevant.':
    'Les favoris doivent reduire la friction. Reouvrez un profil, discutez, creez une demande ou nettoyez la shortlist.',
  'Saved now': 'Sauvegardes maintenant',
  'Verified inside shortlist': 'Verifies dans la shortlist',
  'Ready to message': 'Pret a contacter',
  'Ready to request': 'Pret a demander',
  'This is a working shortlist, not a passive list. Every card can move directly into action.':
    'Shortlist operationnelle: chaque carte mene a une action.',
  'Explore more providers': 'Explorer plus de prestataires',
  'Best shortlist signal': 'Meilleur signal shortlist',
  'Highest current rating in your saved shortlist. Use this as the fastest candidate when you want to reopen the pipeline now.':
    'Meilleure note actuelle de votre shortlist sauvegardee.',
  'Save providers from Explore to build a usable shortlist.':
    'Sauvegardez des prestataires depuis Explore pour construire une shortlist utile.',
  'All shortlist': 'Toute la shortlist',
  'Verified only': 'Verifies seulement',
  'Top rated': 'Mieux notes',
  'No providers saved yet.': 'Aucun prestataire sauvegarde pour le moment.',
  'Use Explore to save providers you want to compare or contact later.':
    'Utilisez Explore pour sauvegarder les prestataires a comparer ou contacter.',
  'Open Explore': 'Ouvrir Explore',
  'No providers match this shortlist filter.':
    'Aucun prestataire ne correspond a ce filtre de shortlist.',
  'Try another filter to reopen the rest of your saved providers.':
    'Essayez un autre filtre pour revoir le reste de vos sauvegardes.',
  'Remove favorite': 'Retirer des favoris',
  Removing: 'Suppression',
  'Removing...': 'Suppression...',
  'Failed to load your reviews.': 'Echec du chargement de vos avis.',
  'Review deleted.': 'Avis supprime.',
  'Failed to delete review.': 'Echec de suppression de l avis.',
  'Published reviews': 'Avis publies',
  'Reviews you have written across provider profiles.':
    'Avis que vous avez rediges sur des profils prestataires.',
  'Average rating given': 'Note moyenne donnee',
  'A simple view of how demanding your public feedback has been.':
    'Vue simple de l exigence de vos retours publics.',
  'With written comments': 'Avec commentaires ecrits',
  'Reviews that include context beyond the star rating.':
    'Avis avec contexte au-dela de la note.',
  'Reviews unavailable.': 'Avis indisponibles.',
  'Review history': 'Historique des avis',
  'Manage the feedback you have already published':
    'Gerer les retours deja publies',
  'Reviews shape public trust and discovery ranking. From here you can reopen the provider profile or delete feedback that is no longer accurate.':
    'Les avis influencent la confiance publique et le classement de decouverte.',
  'Total reviews': 'Total des avis',
  'Providers reviewed': 'Prestataires evalues',
  'Ratings given': 'Notes donnees',
  Active: 'Actif',
  'None yet': 'Aucun pour le moment',
  'Delete control': 'Controle de suppression',
  Available: 'Disponible',
  'Your published reviews': 'Vos avis publies',
  'Open the provider profile to add new feedback in context, or remove an outdated review directly from here.':
    'Ouvrez le profil prestataire pour ajouter un avis contextualise ou supprimer un avis obsolete.',
  'Rating distribution': 'Repartition des notes',
  'All reviews': 'Tous les avis',
  'With comments': 'Avec commentaires',
  '4 stars and above': '4 etoiles et plus',
  'You have not published any reviews yet.': 'Vous n avez encore publie aucun avis.',
  'Open a provider profile from Explore when you want to leave public feedback.':
    'Ouvrez un profil prestataire depuis Explore pour laisser un avis public.',
  'No reviews match this filter.': 'Aucun avis ne correspond a ce filtre.',
  'Switch filters to inspect the rest of your published feedback.':
    'Changez de filtre pour inspecter le reste de vos avis publies.',
  Provider: 'Prestataire',
  'Open provider': 'Ouvrir le prestataire',
  'Deleting...': 'Suppression...',
  'No written comment was included with this review.':
    'Aucun commentaire ecrit n etait inclus avec cet avis.',
  Current: 'Actuel',
  CU: 'CL',
  'Lead inbox': 'Boite des leads',
  'Request brief': 'Brief de la demande',
  Lifecycle: 'Cycle de vie',
  'Customer context': 'Contexte client',
  'Quote and status controls': 'Controle du devis et du statut',
  'Operational priorities': 'Priorites operationnelles',
  'Growth levers': 'Leviers de croissance',
  'Recent services': 'Services recents',
  'Public — everyone can see it': 'Public — tout le monde peut la voir',
  'Favorites only — only customers who favorited you':
